...
import com.dev.zaidi.Adapters.FarmerHistoryCollAdapter;
import com.dev.zaidi.Adapters.PayoutesAdapter;
...
import com.dev.zaidi.Views.Trader.FarmerToolBarUI;
...
import static com.dev.zaidi.Views.CommonFuncs.getFarmersCollectionModel;
...
public class FragmentFarmerHistory extends Fragment implements DatePickerDialog.OnDateSetListener {
    ...
    private void setData(List<com.dev.zaidi.Models.Payouts> payouts) {
        if (payouts != null) {
