...
public class AdminMain extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
       ...
       // adapter.addFragment(new com.dev.lishabora.Views.Admin.Fragments.Tf.FragementFarmersList(), "farmers");
        adapter.addFragment(new com.dev.zaidi.Views.Admin.Fragments.Tf.FragmentProductList(), "farmers");
        adapter.addFragment(new com.dev.zaidi.Views.Admin.Fragments.Tf.FragmentRoutes(), "farmers");
        adapter.addFragment(new com.dev.zaidi.Views.Admin.Fragments.Tf.FragmentPayouts(), "farmers");
