...
public class CollectionsAdapter extends RecyclerView.Adapter<CollectionViewHolder> {
    ...
    public void onBindViewHolder(CollectionViewHolder holder, int position) {
        ...
        holder.milkTotalAm.setText(GeneralUtills.Companion.addCommify(String.valueOf(GeneralUtills.Companion.round(model.getMilkAmLtrs(), 1))));
        ...
        holder.milkTotalPm.setText(GeneralUtills.Companion.addCommify(String.valueOf(GeneralUtills.Companion.round(model.getMilkPmLtrs(), 1))));
        ...
        holder.loanTotalPm.setText(GeneralUtills.Companion.addCommify(String.valueOf(GeneralUtills.Companion.round(model.getLoan(), 1))));
        ...
        holder.orderTotalPm.setText(GeneralUtills.Companion.addCommify(String.valueOf(GeneralUtills.Companion.round(model.getOrder(), 1))));
