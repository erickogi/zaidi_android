...
public class FarmerCollectionsAdapter extends RecyclerView.Adapter<FarmerCollectionViewHolder> {
    ...
    public void onBindViewHolder(FarmerCollectionViewHolder holder, int position) {
        ...
        holder.milkTotalAm.setText(String.format("%s %s", GeneralUtills.Companion.round(model.getMilkAmLtrs(), 1), context.getString(R.string.ltrs)));
        ...
        holder.milkTotalPm.setText(String.format("%s %s", GeneralUtills.Companion.round(model.getMilkPmLtrs(), 1), context.getString(R.string.ltrs)));
        ...
        holder.loanTotalPm.setText(String.format("%s %s", GeneralUtills.Companion.round(model.getLoan(), 1), context.getString(R.string.ksh)));
        ...
        holder.orderTotalPm.setText(String.format("%s %s", GeneralUtills.Companion.round(model.getOrder(), 1), context.getString(R.string.ksh)));
